...
# выпадения, а не проценты от 100. При сумме весов 189 фактические шансы:
# 5% ≈ 79.4%, 15% ≈ 18.5%, 30% ≈ 1.6%, 50% ≈ 0.5%. Поменяй числа,
...
async def open_case_handler(request: web.Request) -> web.Response:
    ...
    в пропорции 150:35:3:1). Код одноразовый и живёт, пока не будет
